    ...
    <Layout>
      <div className="p-8">
        ...
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-2xl font-bold text-gray-900">新規工事登録</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                ...
                <p className="mt-1 text-sm text-gray-500">
                  {formData.contractAmount > 0 && `¥${formData.contractAmount.toLocaleString()}`}
                </p>
              </div>
